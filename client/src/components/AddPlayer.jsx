    ...
    <div>
      ...
      <form onSubmit={onSubmitHandler} className='border p-5 mt-3'>
            ...
            <div className="container w-75 mb-5">
                ...
                <input type="text" className="form-control" value={preferredPosition} onChange={ (e) => setPreferredPosition(e.target.value) }/>
                {errors.preferredPositione ?
                    <p className='ms-3 text-danger'>* {errors.preferredPositione.message}</p>
                    : null
                }
            </div>
            <div className='d-flex justify-content-center align-items-center'>
                <button type="submit" className="btn btn-primary me-5" onClick={ handleClick } >Cancel</button>
